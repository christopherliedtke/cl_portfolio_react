        ...
        <div className="privacy-policy container-fuid my-5" id="privacy-policy">
            <div className="container py-5">
                ...
                <p>
                    ...
                    Schreiberhauer Straße 9 <br />
                    10317 Berlin
                </p>
                <p>
                    <strong>E-Mail:</strong> christopherliedtke@gmx.com
                </p>
                ...
                <p>
                    <a href="https://www.privacyshield.gov/participant?id=a2zt000000001L5AAI&amp;status=Active" rel="noopener noreferrer" target="_blank">
                ...
                <p>
                    <a href="https://www.google.com/intl/de/policies/privacy/partners" rel="noopener noreferrer" target="_blank">
                ...
                <p>Sie können die Erfassung Ihrer Daten durch Google Analytics verhindern, indem Sie auf folgenden Link klicken. Es wird ein Opt-Out-Cookie gesetzt, der die Erfassung Ihrer Daten bei zukünftigen Besuchen dieser Website verhindert:&nbsp;[ga-optout text="Google Analytics deaktivieren"]</p>
                ...
                <p>
                    ein sog. Deaktivierungs-Add-on nebst weiteren Informationen hierzu an. Dieses Add-on lässt sich mit den gängigen Internet-Browsern installieren und bietet Ihnen weitergehende Kontrollmöglichkeit über die Daten, die Google bei Aufruf unseres Internetauftritts erfasst. Dabei teilt das Add-on dem JavaScript (ga.js) von Google Analytics mit, dass Informationen zum Besuch unseres Internetauftritts nicht an Google Analytics übermittelt werden sollen. Dies verhindert aber nicht,
                    dass Informationen an uns oder an andere Webanalysedienste übermittelt werden. Ob und welche weiteren Webanalysedienste von uns eingesetzt werden, erfahren Sie natürlich ebenfalls in dieser Datenschutzerklärung.
                </p>
                <h4>Google-Maps</h4>
                ...
                <p>
                    ...
                    <a href="http://www.google.de/accounts/TOS" rel="noopener noreferrer" target="_blank">
                        Google-Nutzungsbedingungen
                    </a>
                    <a href="https://policies.google.com/terms?gl=DE&amp;hl=de" rel="noopener noreferrer" target="_blank">
                        https://policies.google.com/terms?gl=DE&amp;hl=de
                    </a>{' '}
                    und den{' '}
                    <a href="http://www.google.com/intl/de_de/help/terms_maps.html" rel="noopener noreferrer" target="_blank">
                ...
                <p>
                    <a href="https://adssettings.google.com/authenticated" rel="noopener noreferrer" target="_blank">
                ...
                <p>
                    Wir nutzen YouTube im Zusammenhang mit der Funktion „Erweiterter Datenschutzmodus“, um Ihnen Videos anzeigen zu können. Rechtsgrundlage ist Art. 6 Abs. 1 lit. f) DSGVO. Unser berechtigtes Interesse liegt in der Qualitätsverbesserung unseres Internetauftritts. Die Funktion „Erweiterter Datenschutzmodus“ bewirkt laut Angaben von YouTube, dass die nachfolgend noch näher bezeichneten Daten nur dann an den Server von YouTube übermittelt werden, wenn Sie ein Video auch tatsächlich
                    starten.
                </p>
