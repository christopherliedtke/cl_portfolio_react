            ...
            <Carousel.Item>
              <div className="project px-0" id="stadtUndGruen">
                <div className="row px-0 mx-0">
                  <div
                    className="col-12 col-lg-7 px-lg-5 logo-bg"
                    style={{
                      backgroundImage: "url(/img/logo_stadtundgruen.png)",
                    }}
                  >
                    <h2 style={{ color: projects.stadtUndGruen.hex }}>
                      {t("projects.stadtUndGruen.title")}
                    </h2>
                    ...
                    <div className="btn-box">
                      <a
                        ...
                        role="button"
                        href="https://www.stadtundgruen.com"
                        target="__blank noopener"
                      >
                        {t("projects.btnPage")}
                      </a>
                    </div>
                    <Fade left duration={2000}>
                      <div className="testimonial">
                        ...
                        <div className="col-3 col-md-2 p-0 pl-3">
                          <img
                            className="img-fluid rounded-circle imgTestimonial"
                            src="/img/MarcelFrischmuth_testimonial_200x200.jpg"
                            alt="Portrait Marcel Frischmuth"
                          />
                        </div>
                        <div className="col-9 col-md-10">
                          <blockquote className="blockquote text-right pr-lg-4">
                            <p className="mb-2">
                              {t("projects.stadtUndGruen.testimonial.text")}
                            </p>
                            <footer className="blockquote-footer">
                              {t("projects.stadtUndGruen.testimonial.name")} |{" "}
                              <cite title="Source Title">
                                {t(
                                  "projects.stadtUndGruen.testimonial.company"
                                )}
                              </cite>
                            </footer>
                          </blockquote>
                  ...
                  <div className="col-12 col-lg-5 img-set my-5 py-5 pl-5">
                    <div
                      ...
                      style={{ backgroundColor: projects.stadtUndGruen.hex }}
                    >
                      <Fade bottom duration={2000}>
                        <img
                          className="img-desktop"
                          src="/img/StadtUndGruen_notebook_800x450.png"
                          alt="Stadt und Grün Dektop Landing Page"
                        />
                      </Fade>
                      <Fade bottom duration={2000} delay={750}>
                        <img
                          className="img-tablet "
                          src="/img/StadtUndGruen_tablet_400x553.png"
                          alt="Stadt und Grün Tablet Landing Page"
                        />
                      </Fade>
                      <Fade bottom duration={2000} delay={1500}>
                        <img
                          className="img-mobile "
                          src="/img/StadtUndGruen_mobile_300x594.png"
                          alt="Stadt und Grün Mobile Landing Page"
                        />
                      </Fade>
                    </div>
                  </div>
            ...
            <Carousel.Item>
              <div className="project px-0" id="travelbook">
                <div className="row px-0 mx-0">
                  <div
                    className="col-12 col-lg-7 px-lg-5 logo-bg"
                    style={{ backgroundImage: "url(/img/travelbook_logo.png)" }}
                  >
                    <h2 style={{ color: projects.travelbook.hex }}>
                      {t("projects.travelbook.title")}
                    </h2>
                    ...
                    <div className="btn-box">
                      ...
                      <a
                        className="btn btn-primary d-flex align-items-center my-1"
                        role="button"
                        href="https://github.com/christopherliedtke/social-network_travelbook"
                        target="__blank noopener"
                      >
                  ...
                  <div className="col-12 col-lg-5 img-set-2 px-4 px-md-5 py-5 py-md-3">
                    <Fade bottom duration={2000}>
                      <img
                        className="img-fluid"
                        src="/img/travelbook_register_800x600.jpg"
                        alt="Travelbook - Registrierung"
                      />
                    </Fade>
                    <Fade bottom duration={2000} delay={750}>
                      <img
                        className="img-fluid"
                        src="/img/travelbook_search_800x600.jpg"
                        alt="Travelbook - Suche nach anderen Nutzern"
                      />
                    </Fade>
                    <Fade bottom duration={2000} delay={1500}>
                      <img
                        className="img-fluid"
                        src="/img/travelbook_chat_800x600.jpg"
                        alt="Travelbook - Privater Chat mit anderem Nutzer"
                      />
                    </Fade>
                  </div>
                </div>
              ...
              <div className="project px-0" id="mountainView">
                <div className="row px-0 mx-0">
                  <div
                    className="col-12 col-lg-7 px-lg-5 logo-bg"
                    style={{
                      backgroundImage: "url(/img/mountainView_logo.png)",
                    }}
                  >
                    <h2 style={{ color: projects.mountainView.hex }}>
                      {t("projects.mountainView.title")}
                    </h2>
                    ...
                    <div className="btn-box">
                      <a
                        className="btn btn-primary d-flex align-items-center my-1"
                        role="button"
                        href="https://github.com/christopherliedtke/imageboard_mountainview"
                        target="__blank noopener"
                      >
                        <FaGithub size="20" className="mr-2" /> GitHub
                      </a>
                  ...
                  <div className="col-12 col-lg-5 img-set-2 px-4 px-md-5 py-5 py-md-3">
                    <Fade bottom duration={2000}>
                      <img
                        className="img-fluid"
                        src="/img/mountainView_home_800x600.jpg"
                        alt="mountainView - Home"
                      />
                    </Fade>
                    <Fade bottom duration={2000} delay={750}>
                      <img
                        className="img-fluid"
                        src="/img/mountainView_byTag_800x600.jpg"
                        alt="mountainView - Bilder nach Tag"
                      />
                    </Fade>
                    <Fade bottom duration={2000} delay={1500}>
                      <img
                        className="img-fluid"
                        src="/img/mountainView_modal_800x600.jpg"
                        alt="mountainView - Detailansicht für Bild"
                      />
                    </Fade>
                  </div>
                </div>
            ...
            <Carousel.Item>
              <div className="project px-0" id="freeOrcas">
                <div className="row px-0 mx-0">
                  <div
                    className="col-12 col-lg-7 px-lg-5 logo-bg"
                    style={{ backgroundImage: "url(/img/freeOrcas_logo.png)" }}
                  >
                    <h2 style={{ color: projects.freeOrcas.hex }}>
                      {t("projects.freeOrcas.title")}
                    </h2>
                    ...
                    <div className="btn-box">
                      {/* <a
                        ...
                        role="button"
                        href="http://free-willy.herokuapp.com/"
                        target="__blank noopener"
                      >
                        {t("projects.btnPage")}
                      </a> */}
                      <a
                        className="btn btn-primary d-flex align-items-center my-1"
                        role="button"
                        href="https://github.com/christopherliedtke/petition_free-orcas"
                        target="__blank noopener"
                      >
                        <FaGithub size="20" className="mr-2" /> GitHub
                      </a>
                  ...
                  <div className="col-12 col-lg-5 img-set-2 px-4 px-md-5 py-5 py-md-3">
                    <Fade bottom duration={2000}>
                      <img
                        className="img-fluid"
                        src="/img/freeOrcas_register_800x600.jpg"
                        alt="Free Orcas - Home"
                      />
                    </Fade>
                    <Fade bottom duration={2000} delay={750}>
                      <img
                        className="img-fluid"
                        src="/img/freeOrcas_signature_800x600.jpg"
                        alt="Free Orcas - Signatur hinterlegen"
                      />
                    </Fade>
                    <Fade bottom duration={2000} delay={1500}>
                      <img
                        className="img-fluid"
                        src="/img/freeOrcas_signersByCity_800x600.jpg"
                        alt="Free Orcas - Liste der Unterstützer nach Stadt"
                      />
                    </Fade>
                  </div>
                </div>
